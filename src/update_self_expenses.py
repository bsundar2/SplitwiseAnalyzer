...
def update_self_expense(client: SplitwiseClient, expense_id: int, amount: float, my_user_id: int) -> bool:
...
def main():
    ...
    LOG.info(f"Filtering for expenses between user {my_user_id} and self-expense user {self_user_id}")
